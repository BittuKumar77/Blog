...
class NewRegistrationForm(UserCreationForm):
    email = forms.EmailField(required=True, widget=forms.EmailInput(attrs={'placeholder':'mark77@gmail.com','class':'form-control'}))
    ...
    def save(self,commit=True):
        user = super(NewRegistrationForm, self).save(False)
